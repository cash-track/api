...
class RuleFactory
{
     ...
     * would also tighten routes like /v1/auth/register/check/nick-name or /v1/auth/login/passkey,
     * which must stay on the default guest limit.
     *
     * @var array<string, array{slug: string, limit: int, ttl: int}>
     */
    private const array ENDPOINT_RULES = [
        'POST /v1/auth/login' => ['slug' => 'login', 'limit' => 15, 'ttl' => 60],
        'POST /v1/auth/register' => ['slug' => 'register', 'limit' => 3, 'ttl' => 60],
        'POST /v1/auth/password/forgot' => ['slug' => 'password-forgot', 'limit' => 3, 'ttl' => 60],
        'POST /v1/auth/password/reset' => ['slug' => 'password-reset', 'limit' => 5, 'ttl' => 60],
    ];
